...
<body style="font-family: Open Sans, sans-serif" class="bg-gray-900 text-gray-400">
    <section class="px-6 py-8">
        ...
        >
            <img src="/images/dark-lary-newsletter-icon.png" alt="" class="mx-auto -mb-6" style="width: 145px;">
